...
<template>
  <div class="w-full">
    <label class="block mb-2 text-sm font-medium text-gray-900 text-left" :for="name">{{ label }}
    </label>
    <select :name="name" :id="name" :placeholder="placeholder" :items="items" item-value="" v-model="model"
